...
class OrderDocs
{
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'include', in: 'query', description: 'Comma-separated relations to include: measurement, styleImages', required: false, schema: new OA\Schema(type: 'string', example: 'measurement,styleImages')),
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(property: 'currency', type: 'string', enum: ['NGN', 'USD', 'GBP', 'EUR'], default: 'NGN'),
                    ...
                    new OA\Property(property: 'deposit', type: 'number', format: 'float', nullable: true, minimum: 0, example: 5000, description: 'Optional upfront deposit — recorded as an initial cash payment'),
                ]
            )
        ),
        responses: [
    ...
    #[OA\Patch(
        ...
        description: 'Update any combination of order fields — details, status, measurement, amounts, dates — in a single request. All fields are optional.',
        tags: ['Orders'],
        security: [['bearerAuth' => []]],
        parameters: [
            new OA\Parameter(name: 'client', in: 'path', description: 'Client UUID', required: true, schema: new OA\Schema(type: 'string', format: 'uuid')),
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                properties: [
                    ...
                    new OA\Property(property: 'measurement_id', type: 'string', format: 'uuid', nullable: true, description: 'Link order to a measurement profile'),
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    new OA\Property(property: 'style_image_id', type: 'string', description: 'ID of the style image to attach'),
                ]
            )
        ),
        responses: [
            ...
            new OA\Response(response: 401, description: 'Unauthenticated'),
            new OA\Response(response: 403, description: 'Unauthorized'),
            new OA\Response(response: 404, description: 'Order or style image not found'),
            new OA\Response(response: 422, description: 'Validation error'),
        ]
    )]
    ...
    #[OA\Delete(
        ...
        parameters: [
            new OA\Parameter(name: 'client', in: 'path', description: 'Client UUID', required: true, schema: new OA\Schema(type: 'string', format: 'uuid')),
            new OA\Parameter(name: 'order', in: 'path', description: 'Order UUID', required: true, schema: new OA\Schema(type: 'string', format: 'uuid')),
            new OA\Parameter(name: 'style', in: 'path', description: 'Style image ID', required: true, schema: new OA\Schema(type: 'string')),
        ],
        responses: [
            new OA\Response(response: 200, description: 'Style unlinked from order successfully'),
            new OA\Response(response: 401, description: 'Unauthenticated'),
            new OA\Response(response: 403, description: 'Unauthorized'),
            new OA\Response(response: 404, description: 'Order, style image, or link not found'),
        ]
    )]
